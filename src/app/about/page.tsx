...
export const metadata: Metadata = {
  title: "เกี่ยวกับเรา",
  description:
    "เรียนรู้เกี่ยวกับ บริษัท การวิจัยนวัตกรรมเพื่อคนพิการ วิสาหกิจเพื่อสังคม",
};
...
export default function AboutPage() {
  return (
    <div style={{ paddingTop: "70px", minHeight: "100vh" }}>
      ...
      <div
        style={{ maxWidth: "1000px", margin: "0 auto", padding: "60px 24px" }}
      >
        {/* Stats */}
        <div
          style={{
        ...
        >
          {STATS.map((stat) => (
            <div key={stat.label} style={{ textAlign: "center" }}>
              ...
              <div style={{ fontSize: "17px", color: "var(--text-mid)" }}>
                {stat.label}
              </div>
            </div>
          ))}
        ...
        >
          {[
            ...
            >
              ...
              <div style={{ fontSize: '15px', color: 'var(--text-mid)', lineHeight: 1.5 }}>
                {item.label}
              </div>
            </div>
          ))}
        ...
        <section aria-labelledby="about-mission">
          ...
          >
            {COMPANY.description} เราทำงานร่วมกับคนพิการ นักวิจัย นักออกแบบ
            และผู้กำหนดนโยบาย
            เพื่อสร้างสังคมที่ทุกคนสามารถมีส่วนร่วมได้อย่างเท่าเทียม
          </p>
        </section>
            ...
            {[
              {
                icon: <HandshakeIcon />,
                title: "ความเท่าเทียม",
                desc: "ทุกคนมีสิทธิ์เข้าถึงทรัพยากรและโอกาสอย่างเท่าเทียม",
              },
              {
                icon: <MicroscopeIcon />,
                title: "หลักฐานเชิงประจักษ์",
                desc: "การตัดสินใจบนพื้นฐานงานวิจัยและข้อมูลที่น่าเชื่อถือ",
              },
              {
                icon: <AccessibilityIcon />,
                title: "ออกแบบเพื่อทุกคน",
                desc: "Universal Design ที่รองรับความต้องการที่หลากหลาย",
              },
              {
                icon: <LeafIcon />,
                title: "ยั่งยืน",
                desc: "สร้างผลกระทบที่ยั่งยืนต่อสังคมและสิ่งแวดล้อม",
              },
            ].map((v) => (
              <div
                key={v.title}
              ...
              >
                <div
                  style={{ marginBottom: "12px", color: "var(--teal)" }}
                  aria-hidden="true"
                >
                  {v.icon}
                </div>
        ...
        >
          ...
          >
            <dt style={{ color: "rgba(255,255,255,0.6)" }}>ก่อตั้ง</dt>
            <dd style={{ margin: 0 }}>2566</dd>
            <dt style={{ color: "rgba(255,255,255,0.6)" }}>
              จดทะเบียนวิสาหกิจเพื่อสังคม
            </dt>
            <dd style={{ margin: 0 }}>2568</dd>
            ...
            <dd style={{ margin: 0 }}>
              <a href={`tel:${COMPANY.phone}`} style={{ color: "#2DA88E" }}>
                {COMPANY.phone}
              </a>
            </dd>
            <dt style={{ color: "rgba(255,255,255,0.6)" }}>อีเมล</dt>
            <dd style={{ margin: 0 }}>
              <a href={`mailto:${COMPANY.email}`} style={{ color: "#2DA88E" }}>
                {COMPANY.email}
              </a>
            </dd>
          </dl>
