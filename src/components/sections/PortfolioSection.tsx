...
import { PORTFOLIO_ITEMS, PRODUCTS, SERVICES, ACTIVITIES } from "@/lib/constants";
...
const mergedItems: PortfolioItem[] = [
  ...
  ...PRODUCTS.map((product) => ({
    ...
    year: "2567",
    image: product.image || "/products/default-product.jpg",
  ...
  ...SERVICES.map((service) => ({
    ...
    year: "2567",
    image: service.image || "/services/default-service.jpg",
    imageType: "cover" as const,
  ...
  ...ACTIVITIES.map((activity) => ({
    ...
    year: activity.date,
    reach: activity.location,
  })),
];

const allItems = itemsProp ?? mergedItems;
const filtered =
  activeFilter === "all"
    ? allItems.slice(0, 6)
  ...
  return (
    ...
    >
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        ...
        {filtered.length === 0 && (
          <div style={{ padding: "60px 24px", textAlign: "center", color: "var(--text-mid)", fontFamily: "var(--font-sarabun)", fontSize: "17px" }}>
            ไม่มีข้อมูล
          </div>
        )}
                ...
                <article
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.boxShadow =
                      "0 12px 40px rgba(13,43,69,0.12)";
                  }}
                  onMouseLeave={(e) => {
                ...
                >
                  ...
                  <div style={{ padding: "24px" }}>
                    ...
                    >
                      ...
                      {item.reach && (
                        <span>
                          {item.category === "activity" ? <LocationIcon /> : <PersonIcon />} {item.reach}
                        </span>
                      )}
                      {item.status && (
                        <span>
