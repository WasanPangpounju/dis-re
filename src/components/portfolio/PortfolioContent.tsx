...
import { PORTFOLIO_ITEMS, PRODUCTS, ACTIVITIES } from "@/lib/constants";
import type { PortfolioItem, Product, Activity } from "@/lib/types";
            ...
            >
              ...
              <div style={{ padding: "24px" }}>
                ...
                >
                  ...
                  {item.team && (
                    <span>
                      <PeopleIcon /> {item.team}
                    </span>
                  )}
                  {item.award && (
                    <span>
                      <TrophySmallIcon /> {item.award}
                    </span>
                  )}
                  {item.reach && (
                    <span>
